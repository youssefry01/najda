...
public class AuthServiceImpl implements AuthService {
    ...
    /**
     * Generates a throwaway password guaranteed to satisfy Firebase's
     * enforced Password Policy (upper, lower, digit, special char, sufficient
     * length) -- this password is never actually used by anyone; the employee
     * sets their own real password via the reset link generated right after.
     * A plain UUID string fails this, since it's lowercase hex + dashes only.
     */
    private static final SecureRandom SECURE_RANDOM = new SecureRandom();
    private String generateCompliantTemporaryPassword() {
        String upper = "ABCDEFGHJKLMNPQRSTUVWXYZ"; // no I/O to avoid visual ambiguity, unused anyway
