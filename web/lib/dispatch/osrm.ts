...
// router.project-osrm.org is a free public demo server -- same tradeoff
// as Overpass elsewhere in this build: fine for a grad project, rate-limited,
// not something to depend on for production traffic.
